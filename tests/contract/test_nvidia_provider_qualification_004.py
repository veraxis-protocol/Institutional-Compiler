...
SCRIPT = ROOT / "scripts/qualify_nvidia_provider_004.py"

TARGET_DIR = ROOT / "benchmarks/characterization/definition-ontology-staged-decomposition-004"
...
def test_probe_semantics_unchanged_from_003a() -> None:
    plan = json.loads(PLAN.read_text(encoding="utf-8"))
...
def test_only_qualified_authorizes_ontology_004() -> None:
    plan = json.loads(PLAN.read_text(encoding="utf-8"))
