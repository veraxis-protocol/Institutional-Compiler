...
STAGE_2_RAW_RESULT_PATH: Final = Path(
    "/private/tmp/cdc-e2e-stage2-run-001/CDC-END-TO-END-MISSION-001-STAGE-2-RAW-RESULT-v0.1.json"
)
STAGE_2_RAW_RESULT_SHA256: Final = (
    "715a97038be184f5f0715a9e53d9ceb9150bf74b72e1ff2f4d27654c2b61d45d"
)

CORRECTION_RESULT_PATH: Final = Path(
    "/private/tmp/cdc-e2e-m12-correction-successor-run-002/"
