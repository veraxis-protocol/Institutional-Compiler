"""Single-use result-bearing execution harness for integration slice 001, RUN-002, v0.3.
...
EXECUTION_CANDIDATE_PATH: Final = (
    DOCS / "CDC-INTEGRATION-SLICE-001-RUN-002-EXECUTION-AUTHORIZATION-v0.3.CANDIDATE.json"
)
...
RUNNER_IDENTITY: Final = "CDC-INTEGRATION-SLICE-001-RUN-002-EXECUTION-HARNESS-v0.3"
...
def preflight() -> dict[str, Any]:
    ...
    check("node_accounting_runner_identity_exact",
          "CDC-INTEGRATION-SLICE-001-RUN-002-EXECUTION-HARNESS-v0.3", RUNNER_IDENTITY)
